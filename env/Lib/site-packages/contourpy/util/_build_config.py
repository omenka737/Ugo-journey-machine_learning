...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"C:/Users/DELL/Desktop/Sample_Project_1/env/python.exe",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"C:/miniconda3/conda-bld/contourpy_1763643941183/work/.mesonpy-7xp8i05i/lib/contourpy/util",
        source_dir=r"C:/miniconda3/conda-bld/contourpy_1763643941183/work/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True '--native-file=C:/miniconda3/conda-bld/contourpy_1763643941183/work/.mesonpy-7xp8i05i/meson-python-native-file.ini'",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
