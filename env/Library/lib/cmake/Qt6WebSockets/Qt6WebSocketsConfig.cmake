...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6WebSocketsTargetsPrecheck.cmake")

if(NOT __qt_WebSockets_skip_include_targets_file AND Qt6WebSockets_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6WebSocketsExtraProperties.cmake"
        OPTIONAL)
    set(__qt_WebSockets_targets_file_included ON)
endif()
...
if (Qt6WebSockets_FOUND
    ...
    find_package(Qt6WebSocketsPrivate "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_WebSockets_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::WebSockets)
    ...
    if(NOT DEFINED Qt6WebSockets_NOT_FOUND_MESSAGE)
        ...
        if(__qt_WebSockets_skip_include_targets_file)
            string(APPEND Qt6WebSockets_NOT_FOUND_MESSAGE
                "Possibly due to __qt_WebSockets_skip_include_targets_file being set to TRUE and thus "
