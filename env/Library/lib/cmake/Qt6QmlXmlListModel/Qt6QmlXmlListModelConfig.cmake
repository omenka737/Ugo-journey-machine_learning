...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QmlXmlListModelTargetsPrecheck.cmake")

if(NOT __qt_QmlXmlListModel_skip_include_targets_file AND Qt6QmlXmlListModel_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6QmlXmlListModelExtraProperties.cmake"
        OPTIONAL)
    set(__qt_QmlXmlListModel_targets_file_included ON)
endif()
...
if (Qt6QmlXmlListModel_FOUND
    ...
    find_package(Qt6QmlXmlListModelPrivate "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_QmlXmlListModel_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::QmlXmlListModel)
    ...
    if(NOT DEFINED Qt6QmlXmlListModel_NOT_FOUND_MESSAGE)
        ...
        if(__qt_QmlXmlListModel_skip_include_targets_file)
            string(APPEND Qt6QmlXmlListModel_NOT_FOUND_MESSAGE
                "Possibly due to __qt_QmlXmlListModel_skip_include_targets_file being set to TRUE and thus "
