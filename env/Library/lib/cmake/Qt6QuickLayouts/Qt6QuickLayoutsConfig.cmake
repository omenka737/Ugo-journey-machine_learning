...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickLayoutsTargetsPrecheck.cmake")

if(NOT __qt_QuickLayouts_skip_include_targets_file AND Qt6QuickLayouts_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickLayoutsExtraProperties.cmake"
        OPTIONAL)
    set(__qt_QuickLayouts_targets_file_included ON)
endif()
...
if (Qt6QuickLayouts_FOUND
    ...
    find_package(Qt6QuickLayoutsPrivate "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_QuickLayouts_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::QuickLayouts)
    ...
    if(NOT DEFINED Qt6QuickLayouts_NOT_FOUND_MESSAGE)
        ...
        if(__qt_QuickLayouts_skip_include_targets_file)
            string(APPEND Qt6QuickLayouts_NOT_FOUND_MESSAGE
                "Possibly due to __qt_QuickLayouts_skip_include_targets_file being set to TRUE and thus "
