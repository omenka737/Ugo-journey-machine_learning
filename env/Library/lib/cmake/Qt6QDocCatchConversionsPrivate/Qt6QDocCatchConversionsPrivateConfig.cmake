...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QDocCatchConversionsPrivateTargetsPrecheck.cmake")

if(NOT __qt_QDocCatchConversionsPrivate_skip_include_targets_file AND Qt6QDocCatchConversionsPrivate_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6QDocCatchConversionsPrivateExtraProperties.cmake"
        OPTIONAL)
    set(__qt_QDocCatchConversionsPrivate_targets_file_included ON)
endif()
...
if (Qt6QDocCatchConversionsPrivate_FOUND
    ...
    find_package(Qt6QDocCatchConversionsPrivatePrivate "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_QDocCatchConversionsPrivate_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::QDocCatchConversionsPrivate)
    ...
    if(NOT DEFINED Qt6QDocCatchConversionsPrivate_NOT_FOUND_MESSAGE)
        ...
        if(__qt_QDocCatchConversionsPrivate_skip_include_targets_file)
            string(APPEND Qt6QDocCatchConversionsPrivate_NOT_FOUND_MESSAGE
                "Possibly due to __qt_QDocCatchConversionsPrivate_skip_include_targets_file being set to TRUE and thus "
