...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QmlCompilerTargetsPrecheck.cmake")

if(NOT __qt_QmlCompiler_skip_include_targets_file AND Qt6QmlCompiler_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6QmlCompilerExtraProperties.cmake"
        OPTIONAL)
    set(__qt_QmlCompiler_targets_file_included ON)
endif()
...
if (Qt6QmlCompiler_FOUND
    ...
    find_package(Qt6QmlCompilerPrivate "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_QmlCompiler_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::QmlCompiler)
    ...
    if(NOT DEFINED Qt6QmlCompiler_NOT_FOUND_MESSAGE)
        ...
        if(__qt_QmlCompiler_skip_include_targets_file)
            string(APPEND Qt6QmlCompiler_NOT_FOUND_MESSAGE
                "Possibly due to __qt_QmlCompiler_skip_include_targets_file being set to TRUE and thus "
