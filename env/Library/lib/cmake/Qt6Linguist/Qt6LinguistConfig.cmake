...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6LinguistTargetsPrecheck.cmake")

if(NOT __qt_Linguist_skip_include_targets_file AND Qt6Linguist_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6LinguistExtraProperties.cmake"
        OPTIONAL)
    set(__qt_Linguist_targets_file_included ON)
endif()
...
if (Qt6Linguist_FOUND
    ...
    find_package(Qt6LinguistPrivate "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_Linguist_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::Linguist)
    ...
    if(NOT DEFINED Qt6Linguist_NOT_FOUND_MESSAGE)
        ...
        if(__qt_Linguist_skip_include_targets_file)
            string(APPEND Qt6Linguist_NOT_FOUND_MESSAGE
                "Possibly due to __qt_Linguist_skip_include_targets_file being set to TRUE and thus "
