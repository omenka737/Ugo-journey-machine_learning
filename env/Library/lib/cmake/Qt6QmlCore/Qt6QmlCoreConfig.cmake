...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QmlCoreTargetsPrecheck.cmake")

if(NOT __qt_QmlCore_skip_include_targets_file AND Qt6QmlCore_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6QmlCoreExtraProperties.cmake"
        OPTIONAL)
    set(__qt_QmlCore_targets_file_included ON)
endif()
...
if (Qt6QmlCore_FOUND
    ...
    find_package(Qt6QmlCorePrivate "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_QmlCore_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::QmlCore)
    ...
    if(NOT DEFINED Qt6QmlCore_NOT_FOUND_MESSAGE)
        ...
        if(__qt_QmlCore_skip_include_targets_file)
            string(APPEND Qt6QmlCore_NOT_FOUND_MESSAGE
                "Possibly due to __qt_QmlCore_skip_include_targets_file being set to TRUE and thus "
