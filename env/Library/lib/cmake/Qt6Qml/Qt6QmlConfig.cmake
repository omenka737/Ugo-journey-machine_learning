...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QmlTargetsPrecheck.cmake")

if(NOT __qt_Qml_skip_include_targets_file AND Qt6Qml_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6QmlExtraProperties.cmake"
        OPTIONAL)
    set(__qt_Qml_targets_file_included ON)
endif()
...
if (Qt6Qml_FOUND
    ...
    find_package(Qt6QmlPrivate "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_Qml_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::Qml)
    ...
    if(NOT DEFINED Qt6Qml_NOT_FOUND_MESSAGE)
        ...
        if(__qt_Qml_skip_include_targets_file)
            string(APPEND Qt6Qml_NOT_FOUND_MESSAGE
                "Possibly due to __qt_Qml_skip_include_targets_file being set to TRUE and thus "
