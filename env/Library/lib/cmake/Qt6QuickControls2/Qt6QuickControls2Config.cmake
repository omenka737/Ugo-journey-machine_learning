...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickControls2TargetsPrecheck.cmake")

if(NOT __qt_QuickControls2_skip_include_targets_file AND Qt6QuickControls2_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickControls2ExtraProperties.cmake"
        OPTIONAL)
    set(__qt_QuickControls2_targets_file_included ON)
endif()
...
if (Qt6QuickControls2_FOUND
    ...
    find_package(Qt6QuickControls2Private "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_QuickControls2_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::QuickControls2)
    ...
    if(NOT DEFINED Qt6QuickControls2_NOT_FOUND_MESSAGE)
        ...
        if(__qt_QuickControls2_skip_include_targets_file)
            string(APPEND Qt6QuickControls2_NOT_FOUND_MESSAGE
                "Possibly due to __qt_QuickControls2_skip_include_targets_file being set to TRUE and thus "
