...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QmlIntegrationTargetsPrecheck.cmake")

if(NOT __qt_QmlIntegration_skip_include_targets_file AND Qt6QmlIntegration_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6QmlIntegrationExtraProperties.cmake"
        OPTIONAL)
    set(__qt_QmlIntegration_targets_file_included ON)
endif()
...
if (Qt6QmlIntegration_FOUND
    ...
    find_package(Qt6QmlIntegrationPrivate "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_QmlIntegration_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::QmlIntegration)
    ...
    if(NOT DEFINED Qt6QmlIntegration_NOT_FOUND_MESSAGE)
        ...
        if(__qt_QmlIntegration_skip_include_targets_file)
            string(APPEND Qt6QmlIntegration_NOT_FOUND_MESSAGE
                "Possibly due to __qt_QmlIntegration_skip_include_targets_file being set to TRUE and thus "
