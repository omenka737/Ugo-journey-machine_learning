...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QmlNetworkTargetsPrecheck.cmake")

if(NOT __qt_QmlNetwork_skip_include_targets_file AND Qt6QmlNetwork_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6QmlNetworkExtraProperties.cmake"
        OPTIONAL)
    set(__qt_QmlNetwork_targets_file_included ON)
endif()
...
if (Qt6QmlNetwork_FOUND
    ...
    find_package(Qt6QmlNetworkPrivate "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_QmlNetwork_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::QmlNetwork)
    ...
    if(NOT DEFINED Qt6QmlNetwork_NOT_FOUND_MESSAGE)
        ...
        if(__qt_QmlNetwork_skip_include_targets_file)
            string(APPEND Qt6QmlNetwork_NOT_FOUND_MESSAGE
                "Possibly due to __qt_QmlNetwork_skip_include_targets_file being set to TRUE and thus "
