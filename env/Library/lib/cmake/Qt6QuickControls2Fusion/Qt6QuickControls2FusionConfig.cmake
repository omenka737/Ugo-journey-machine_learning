...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickControls2FusionTargetsPrecheck.cmake")

if(NOT __qt_QuickControls2Fusion_skip_include_targets_file AND Qt6QuickControls2Fusion_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickControls2FusionExtraProperties.cmake"
        OPTIONAL)
    set(__qt_QuickControls2Fusion_targets_file_included ON)
endif()
...
if (Qt6QuickControls2Fusion_FOUND
    ...
    find_package(Qt6QuickControls2FusionPrivate "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_QuickControls2Fusion_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::QuickControls2Fusion)
    ...
    if(NOT DEFINED Qt6QuickControls2Fusion_NOT_FOUND_MESSAGE)
        ...
        if(__qt_QuickControls2Fusion_skip_include_targets_file)
            string(APPEND Qt6QuickControls2Fusion_NOT_FOUND_MESSAGE
                "Possibly due to __qt_QuickControls2Fusion_skip_include_targets_file being set to TRUE and thus "
