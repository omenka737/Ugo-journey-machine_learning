...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickTargetsPrecheck.cmake")

if(NOT __qt_Quick_skip_include_targets_file AND Qt6Quick_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickExtraProperties.cmake"
        OPTIONAL)
    set(__qt_Quick_targets_file_included ON)
endif()
...
if (Qt6Quick_FOUND
    ...
    find_package(Qt6QuickPrivate "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_Quick_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::Quick)
    ...
    if(NOT DEFINED Qt6Quick_NOT_FOUND_MESSAGE)
        ...
        if(__qt_Quick_skip_include_targets_file)
            string(APPEND Qt6Quick_NOT_FOUND_MESSAGE
                "Possibly due to __qt_Quick_skip_include_targets_file being set to TRUE and thus "
