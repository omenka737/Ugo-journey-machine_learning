...
get_target_property(_qt_imported_location Qt6::lcheck IMPORTED_LOCATION_RELEASE)
get_target_property(_qt_imported_location_default Qt6::lcheck IMPORTED_LOCATION_${QT_DEFAULT_IMPORT_CONFIGURATION})
...
if(_qt_imported_location)
    set_property(TARGET Qt6::lcheck PROPERTY IMPORTED_LOCATION_RELWITHDEBINFO "${_qt_imported_location}")
endif()

# Import target "Qt6::lcheck" for configuration "MinSizeRel"
set_property(TARGET Qt6::lcheck APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)

if(_qt_imported_location)
    set_property(TARGET Qt6::lcheck PROPERTY IMPORTED_LOCATION_MINSIZEREL "${_qt_imported_location}")
endif()

# Default configuration
if(_qt_imported_location_default)
    set_property(TARGET Qt6::lcheck PROPERTY IMPORTED_LOCATION "${_qt_imported_location_default}")
endif()
...
get_target_property(_qt_imported_location Qt6::ltext2id IMPORTED_LOCATION_RELEASE)
get_target_property(_qt_imported_location_default Qt6::ltext2id IMPORTED_LOCATION_${QT_DEFAULT_IMPORT_CONFIGURATION})
...
if(_qt_imported_location)
    set_property(TARGET Qt6::ltext2id PROPERTY IMPORTED_LOCATION_RELWITHDEBINFO "${_qt_imported_location}")
endif()

# Import target "Qt6::ltext2id" for configuration "MinSizeRel"
set_property(TARGET Qt6::ltext2id APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)

if(_qt_imported_location)
    set_property(TARGET Qt6::ltext2id PROPERTY IMPORTED_LOCATION_MINSIZEREL "${_qt_imported_location}")
endif()

# Default configuration
if(_qt_imported_location_default)
    set_property(TARGET Qt6::ltext2id PROPERTY IMPORTED_LOCATION "${_qt_imported_location_default}")
endif()
