...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickWidgetsTargetsPrecheck.cmake")

if(NOT __qt_QuickWidgets_skip_include_targets_file AND Qt6QuickWidgets_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6QuickWidgetsExtraProperties.cmake"
        OPTIONAL)
    set(__qt_QuickWidgets_targets_file_included ON)
endif()
...
if (Qt6QuickWidgets_FOUND
    ...
    find_package(Qt6QuickWidgetsPrivate "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_QuickWidgets_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::QuickWidgets)
    ...
    if(NOT DEFINED Qt6QuickWidgets_NOT_FOUND_MESSAGE)
        ...
        if(__qt_QuickWidgets_skip_include_targets_file)
            string(APPEND Qt6QuickWidgets_NOT_FOUND_MESSAGE
                "Possibly due to __qt_QuickWidgets_skip_include_targets_file being set to TRUE and thus "
