...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6SvgTargetsPrecheck.cmake")

if(NOT __qt_Svg_skip_include_targets_file AND Qt6Svg_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6SvgExtraProperties.cmake"
        OPTIONAL)
    set(__qt_Svg_targets_file_included ON)
endif()
...
if (Qt6Svg_FOUND
    ...
    find_package(Qt6SvgPrivate "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_Svg_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::Svg)
    ...
    if(NOT DEFINED Qt6Svg_NOT_FOUND_MESSAGE)
        ...
        if(__qt_Svg_skip_include_targets_file)
            string(APPEND Qt6Svg_NOT_FOUND_MESSAGE
                "Possibly due to __qt_Svg_skip_include_targets_file being set to TRUE and thus "
