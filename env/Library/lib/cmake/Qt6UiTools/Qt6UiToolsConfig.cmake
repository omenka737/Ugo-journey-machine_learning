...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6UiToolsTargetsPrecheck.cmake")

if(NOT __qt_UiTools_skip_include_targets_file AND Qt6UiTools_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6UiToolsExtraProperties.cmake"
        OPTIONAL)
    set(__qt_UiTools_targets_file_included ON)
endif()
...
if (Qt6UiTools_FOUND
    ...
    find_package(Qt6UiToolsPrivate "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_UiTools_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::UiTools)
    ...
    if(NOT DEFINED Qt6UiTools_NOT_FOUND_MESSAGE)
        ...
        if(__qt_UiTools_skip_include_targets_file)
            string(APPEND Qt6UiTools_NOT_FOUND_MESSAGE
                "Possibly due to __qt_UiTools_skip_include_targets_file being set to TRUE and thus "
