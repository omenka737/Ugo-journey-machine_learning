...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QmlWorkerScriptTargetsPrecheck.cmake")

if(NOT __qt_QmlWorkerScript_skip_include_targets_file AND Qt6QmlWorkerScript_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6QmlWorkerScriptExtraProperties.cmake"
        OPTIONAL)
    set(__qt_QmlWorkerScript_targets_file_included ON)
endif()
...
if (Qt6QmlWorkerScript_FOUND
    ...
    find_package(Qt6QmlWorkerScriptPrivate "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_QmlWorkerScript_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::QmlWorkerScript)
    ...
    if(NOT DEFINED Qt6QmlWorkerScript_NOT_FOUND_MESSAGE)
        ...
        if(__qt_QmlWorkerScript_skip_include_targets_file)
            string(APPEND Qt6QmlWorkerScript_NOT_FOUND_MESSAGE
                "Possibly due to __qt_QmlWorkerScript_skip_include_targets_file being set to TRUE and thus "
