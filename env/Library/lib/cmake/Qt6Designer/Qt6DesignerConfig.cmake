...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6DesignerTargetsPrecheck.cmake")

if(NOT __qt_Designer_skip_include_targets_file AND Qt6Designer_FOUND)
    ...
    include("${CMAKE_CURRENT_LIST_DIR}/Qt6DesignerExtraProperties.cmake"
        OPTIONAL)
    set(__qt_Designer_targets_file_included ON)
endif()
...
if (Qt6Designer_FOUND
    ...
    find_package(Qt6DesignerPrivate "6.11.0" EXACT
        QUIET
        CONFIG
        PATHS
...
if(__qt_Designer_targets_file_included)
    # DEPRECATED
...
if (TARGET Qt6::Designer)
    ...
    if(NOT DEFINED Qt6Designer_NOT_FOUND_MESSAGE)
        ...
        if(__qt_Designer_skip_include_targets_file)
            string(APPEND Qt6Designer_NOT_FOUND_MESSAGE
                "Possibly due to __qt_Designer_skip_include_targets_file being set to TRUE and thus "
